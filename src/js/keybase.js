...
// function decryptPrivateBundle(passphrase, bundle) {
//   let key = new Buffer(passphrase, 'utf8');
//   let data = new Buffer(bundle, 'utf8');

//   return new Promise((resolve, reject) => {
//     decrypt({key, data}, (err, resp) => {
//       if (err) {
//         console.error('woopwoop', err);
//         reject(err);
//       }
//       resolve(resp);
//     })
